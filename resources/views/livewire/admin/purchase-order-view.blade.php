<div>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg  mt-5">
        ...
        <form wire:submit.prevent="deleteSelectedItems" class="mt-6">
                ...
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3">
                            <i class="fas fa-sort fs-3 hover:text-orange-500" wire:click="sortBy('product_name')"></i>
                            Product Name
                        </th>
                        <th scope="col" class="px-6 py-3">
                            <i class="fas fa-sort fs-3 hover:text-orange-500" wire:click="sortBy('quantity')"></i>
                            Quantity
                        </th>
                        <th scope="col" class="px-6 py-3">
                            <i class="fas fa-sort fs-3 hover:text-orange-500" wire:click="sortBy('status')"></i>
                            Status
                        </th>
                        <th scope="col" class="px-6 py-3">
                            <i class="fas fa-sort fs-3 hover:text-orange-500"
                                wire:click="sortBy('small_description')"></i>
                            Small Description
                        </th> 
                    </tr>
                </thead>
                    ...
                    @if ($purchase)
                        @forelse ($purchase as $item)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    <select id=""
                                        wire:click="changeEvent($event.target.value,{{ $item->id }})"
                                        class="border-none">
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="py-5 text-center text-red-500 text-xl">No Purchase Order
                                    Found
                                    , Notice your chefs </td>
                            </tr>
                        @endforelse
                    @else
                        <tr>
                            ...
                            <div class="p-4   h-full w-full  ">
                                <form wire:submit.prevent="add">
                                    <div class="grid space-y-10 mx-auto  lg:mt-10 md:mt-10 sm:mt-3"
                                        ...
                                        <div class="grid gap-4 grid-cols-1 w-full">
                                            <div class="relative z-0 w-full mb-2 group">
                                                <input type="text" wire:model="small_description"
