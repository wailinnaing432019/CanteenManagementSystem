    ...
    <div class="p-4 border-2 border-gray-200 rounded-lg dark:border-gray-700 h-screen  bg-slate">
        <form action="{{ route('slide#update', $data->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="grid space-y-10 mx-auto shadow-lg lg:mt-10 md:mt-10 sm:mt-3"
                ...
                <div class="flex space-x-6 relative max-w-[900px]">
                    <div class="relative w-1/2">
                        <div>
                            ...
                            <select name="menu_id" id="menuname"
                                ...
                                @forelse ($menu as $m)
                                    <option value="{{ $m->id }}" @if ($data->menu_id == $m->id) selected @endif>
                                        {{ $m->name }}</option>
                                @empty
                ...
                <div class="flex space-x-6 relative max-w-[900px]">
                    <div class="relative w-full">
                        <div>
                            ...
                            <textarea name="description" rows="5" id="slidedes" placeholder=""
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">{{ old('descriptin', $data->description) }}
                        </textarea>
                            @error('description')
                                <p class=" text-red-700">
                                    {{ $message }}
                ...
                <div class="flex space-x-6 max-w-[900px]">
                    <div class="relative w-1/2">
                        <div>
                            <label for="menuimg"
                ...
                <div class="flex justify-end space-x-2 max-w-[900px]">
                    <div
