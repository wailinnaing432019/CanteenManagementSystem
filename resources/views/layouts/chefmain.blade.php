...
<body class="dark:bg-slate-950">
    ...
    <section class="grid grid-flow-row">
        ...
        <div
            class="bg-blue-300  duration-200 animate__animated navbar dark:bg-slate-700 z-30  fixed w-full grid grid-cols-6 dark:text-blue-400 border-blue-400">
            <div
            ...
            <div
                ...
                <div class="">
                    <h1 class="text-2xl text-orange-500 font-bold  dark:text-white">Chef Dashboard</h1>
                    <span class="ml-3 dark:text-white">Hi {{ auth()->guard('staff')->user()->name }}</span>
                </div>
                        ...
                        <ul id="product" class="hidden py-2 space-y-2">
                            <li>
                                <a href="{{ url('chef/menus') }}"
                                    class="flex items-center w-full p-2  transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 text-orange-500 dark:text-white">My
                                    Menu</a>
                            </li>
                            <li>
                                <a href="{{ url('chef/menus/other') }}"
                                    class="flex items-center w-full p-2  transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 text-orange-500 dark:text-white">All
                                    Menus</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="{{ url('chef/purchase-order') }}"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                viewBox="0 0 20 20">
